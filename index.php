...
<header class="navbar">
    <ul class="nav nav-pills nav-fill navul">
        ...
        if(!isset($_SESSION['login'])){
            ...
            echo "<li class='nav-item'><form action='index.php' method='get'><input class='btn btn-link' type='submit' name='disconnect' value='Déconnexion'></form></li>";
    ...
    <div id="carouselExampleCaptions" class="carousel slide " data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="./ressources/slide1.jpg" class="d-block w-100 height" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <h5>Un module de connexion</h5>
                    <p>Par des codeurs grand</p>
                </div>
            </div>
            <div class="carousel-item">
                <img src="./ressources/slide2.jpg" class="d-block w-100 height" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <h5>Avec différentes pages</h5>
                    <p>Qui mettent du style en croyant qu'ils en ont</p>
                </div>
            </div>
            <div class="carousel-item">
                <img src="./ressources/slide3.jpg" class="d-block w-100 height" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <h5>Avec un succès et une connaissance relative</h5>
                    <p>On est la hein</p>
                </div>
            </div>
        </div>
